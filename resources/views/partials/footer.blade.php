...
<script type="text/javascript" src="{{url("")}}/template/scripts/plugins.js"></script>
{{--<script type="text/javascript" src="{{url("")}}/template/scripts/custom.js"></script>--}}
<script>
    function noenter() {
    ...
    $(document).ready(function(){
        ...
        function realtime() {
            $.ajax({
                url: 'http://localhost/skripsi/app-bot-tfidf-new/public/web/chat/result',
                method: 'GET',
        ...
        function kirim() {
            ...
            var settings = {
                url: "http://localhost/skripsi/app-bot-tfidf/bot.php",
                method: "POST",
                data: {
                    _token: '{{csrf_token()}}',
                    email: $('[name="email"]').val(),
                    pertanyaan: $('[name="pertanyaan"]').val()
                }
            }
